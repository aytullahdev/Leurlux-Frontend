        ...
        <div className=''>
            <div className=' lg:mt-0 bg-[#232222]  flex flex-col justify-around h-auto lg:h-screen'>
                ...
                <div className='text-white bg-[#232222] py-1 p-5 ' >
                    ...
                    <div className='flex flex-col  mt-4 text-sm text-left lg:text-left lg:text-xl font-thin'>
                        <p >
                ...
                <div className='text-white bg-[#232222] py-1 p-5 ' >
                    ...
                    <div className=' py-1 pt-5' >
                        <h1 className='font-italian text-4xl py-2'>{`Welcome to LEURLUX`}</h1>
                        <p className='lg:text-xl lg:font-italian font-thin'>{`  Enter the world of LeurLux, where luxury, elegance, and fantastic experiences come together to create memories you'll cherish.
