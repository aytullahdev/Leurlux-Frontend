...
const BookService = () => {
    ...
    return <>
        ...
        <div className='justify-center items-center flex flex-col h-full w-full py-20'>
            <div>
                <h1 className='px-5 lg:px-5 text-2xl lg:text-4xl font-italian py-5'>If You Encounter Booking Issues, Contact Us on <span className='text-bold text-green-500'>WhatsApp!</span></h1>
            </div>
