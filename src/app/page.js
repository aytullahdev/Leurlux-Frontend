  ...
  return (
    <main className="flex min-h-screen flex-col items-start justify-between  cursor-default ">
      ...
      <header onMouseLeave={() => {
        ...
        setIsHover(true)
      }} className='px-5 lg:px-10 bg-no-repeat min-h-[500px] lg:min-h-screen min-w-full py-5 bg-cover flex flex-col justify-center lg:justify-center items-center ' style={{
        ...
        <div className='text-4xl lg:text-8xl gap-5 flex flex-col   font-italian text-center ' >
