    ...
    return (
        <div>
            <div className='relative w-full '>
                ...
                <div className='my-2 lg:my-10  flex justify-center items-center'>
                    <Link href="/book?category=privatejet#top" className='text-xl lg:text-3xl bg-black text-white  px-10 py-2 rounded-lg font-italian '>Get A Guote Now</Link>
                </div>
            ...
            <div id='privatejet' className='lg:py-5'>
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    <div className='bg-white text-black  p-5 '>
                        <h1 className='text-bold font-italian text-4xl py-2 lg:py-5'>Unmatched Affordability</h1>
                        <p className='lg:text-justify text-sm lg:text-xl'> {`What sets LEURLUX apart is not just our commitment to luxury but also our dedication to affordability. We believe that top-tier private jet travel should be accessible to all, and we've achieved this by providing the most competitive prices in the world. Your journey is defined by luxury, not by cost, and we are delighted to make this vision a reality.`}</p>
                    </div>
                    <div className='bg-white text-black px-5 py-2 lg:p-5 '>
                        <h1 className='text-bold font-italian text-4xl py-2 lg:py-5'>Your Journey, Your Way</h1>
                        <p className='lg:text-justify text-sm lg:text-xl'>{`We understand that the needs of our discerning clientele vary. That's why LEURLUX ensures that your journey is as unique as you are. Whether you're traveling for business or pleasure, our expert concierge team tailors your experience to your preferences. No request is too extravagant no detail is too small.`}</p>
                    </div>
                    <div className='my-5 lg:my-10  flex justify-center items-center lg:col-span-2'>
                        <Link href="/book?category=privatejet#top" className='text-xl lg:text-3xl bg-black text-white  px-10 py-2 rounded-lg font-italian '>Get A Guote Now</Link>
                    </div>
                    <div className='bg-white text-black  p-5 lg:col-span-2 '>
                        <h1 className='text-bold font-italian text-4xl py-2 lg:py-5 text-start lg:text-center'>Luxury Beyond the Skies</h1>
                        <p className='lg:text-justify text-sm lg:text-xl'>{`While our private jet service elevates your travel, our commitment to luxury doesn't end upon landing. When you arrive at your destination, you'll be welcomed by our exceptional concierge services that redefine hospitality. From exclusive chauffeur-driven transfers to securing reservations at the world's finest restaurants, we ensure that every moment of your stay is extraordinary.`}
                            <span className='block py-2 lg:py-5 bg-none'></span>
