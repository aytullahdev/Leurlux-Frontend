...
const About = () => {
    ...
    return (
        <>
            <div id='about' className='w-full py-60 bg-cover bg-center  ' onMouseLeave={() => {
                setIsHover(false)
            }} onMouseOver={() => {
                setIsHover(true)
            }} style={{
                ...
                <h1 className='font-italian text-5xl text-center p-5' style={{ color: 'rgb(242, 245, 220)' }}>
            ...
            <div className=''>
                <div className='text-white bg-[#232222] py-20 p-5 ' >
                    ...
                    <div className='flex flex-col  mt-10 text-3xl font-thin'>
                        <p >
